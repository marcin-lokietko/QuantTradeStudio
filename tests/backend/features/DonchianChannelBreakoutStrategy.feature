...
Scenario Outline: Ordering a trade when current close price is more extreme than exit/entry channel extremum
    ...
    When Request POST /startBot is sent with body "{"botName":"DonchianChannelBreakoutStrategy","executionInterval":"OneHour","exitChannelLength":3,"entryChannelLength":6,"quoteAsset":"USDT","baseAssets":["BTC","ETH"]}"
